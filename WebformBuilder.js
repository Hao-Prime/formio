  ...
  _createClass(WebformBuilder, [{
    ...
    value: function attachComponent(element, component) {
      ...
      if (component.refs.copyComponent) {
        this.attachTooltip(component.refs.copyComponent, this.t('Sao chép'));
      ...
      if (component.refs.moveComponent) {
        this.attachTooltip(component.refs.moveComponent, this.t('Di chuyển'));
      ...
      if (component.refs.editComponent) {
        this.attachTooltip(component.refs.editComponent, this.t('Cập nhật'));
      ...
      if (component.refs.removeComponent) {
        this.attachTooltip(component.refs.removeComponent, this.t('Xóa'));
    ...
    value: function removeComponent(component, parent, original) {
      ...
      if (this.options.alwaysConfirmComponentRemoval || removingComponentsGroup) {
        var message = removingComponentsGroup ? 'Việc xóa thành phần này cũng sẽ xóa tất cả các thành phần con của nó. Bạn có chắc chắn muốn thực hiện việc này không?' : 'Are you sure you want to remove this component?';
