...
### Fixed
 ...
 - FIO-4468: Fixes select boxes with Vị trí nhãn tùy chọn left are overlapped on pdf download
...
### Fixed
 ...
 - Fixed the Vị trí nhãn tùy chọns in Radio and Select boxes components.
