...
var _default = [{
  ...
  label: 'Bật chọn ngày',
  weight: 0,
  tooltip: 'Bật nhập ngày cho trường này.'
}, {
  type: 'tags',
  input: true,
  ...
  label: 'Chỉ chọn các ngày trong tuần',
  tooltip: 'Chỉ chọn các ngày trong tuần',
  weight: 23
}, {
  type: 'checkbox',
  input: true,
  key: 'datePicker.disableWeekdays',
  label: 'Chỉ chọn cuối tuần',
  tooltip: 'Chỉ chọn cuối tuần',
  weight: 23
}];
