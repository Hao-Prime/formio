...
var _default = [{
  ...
  input: true,
  key: 'allowInput',
  label: 'Cho phép nhập thủ công trên bàn phím',
  tooltip: 'Đánh dấu vào đây nếu bạn muốn cho phép người dùng nhập ngày theo cách thủ công trên bàn phím.',
  weight: 51
}, {
  type: 'textfield',
  input: true,
  ...
  description: 'Tham khảo kiểu hiện thị tại <a href="https://github.com/angular-ui/bootstrap/tree/master/src/dateparser/docs#uibdateparsers-format-codes" target="_blank" rel="noopener noreferrer">DateParser Codes</a>',
  tooltip: 'Định dạng ngày để hiển thị giá trị ngày giờ.',
  weight: 52
}, {
  type: 'editgrid',
  input: true,
