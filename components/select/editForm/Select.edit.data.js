...
var _default = [{
  ...
  type: 'datagrid',
  input: true,
  label: 'Giá trị nguồn dữ Liệu',
  key: 'data.values',
  tooltip: 'Các giá trị để sử dụng làm nguồn dữ liệu. Nhãn được hiển thị trong trường lựa chọn. Giá trị là các giá trị tương ứng được lưu lại cùng với bản ghi.',
  weight: 10,
  reorder: true,
  defaultValue: [{
    label: '',
  ...
  label: 'Bật Tìm Kiếm',
  defaultValue: true,
  tooltip: 'Khi được chọn, danh sách thả xuống sẽ cho phép tìm kiếm trong danh sách cố định các mục được cung cấp.'
}, {
  type: 'checkbox',
  input: true,
  weight: 21,
