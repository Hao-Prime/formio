...
var _default = [{
  ...
  tooltip: 'Cho phép nhập nhiều giá trị cho trường này.',
  key: 'multiple',
  input: true
}, {
  type: 'textfield',
  ...
  tooltip: 'Giá trị mặc định sẽ là giá trị của trường này trước khi người dùng tương tác. Có một giá trị mặc định sẽ ghi đè lên văn bản gợi ý.',
  input: true
}, {
  weight: 30,
  type: 'radio',
